<?php
 ...
 echo'if (!file_exists(tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M")."/".$id)) {'.PHP_EOL;
 echo'  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y"), 0700);'.PHP_EOL;
 echo'  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M"), 0700);'.PHP_EOL;
 echo'  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M")."/".$id, 0700);'.PHP_EOL;
 echo'}'.PHP_EOL;
 echo'$target_dir = tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M")."/".$id."/";'.PHP_EOL;
 ...
 echo'if($filenameType != "jpg" && $filenameType != "png" && $filenameType != "jpeg"'.PHP_EOL;
 echo'&& $filenameType != "gif" ) {'.PHP_EOL;
 echo'  $val["status"]= "Maaf, hanya file JPG, JPEG, PNG & GIF yang diperbolehkan.";'.PHP_EOL;
 echo'  $uploadOk = 0;'.PHP_EOL;
 echo'}'.PHP_EOL;
