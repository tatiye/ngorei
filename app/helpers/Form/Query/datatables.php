<?php 
 ...
 echo '$val=json_decode(file_get_contents("php://input"),true);'.PHP_EOL;
 echo 'if ($val["limit"]) {'.PHP_EOL;
 echo '   $tabel=$val["tabel"];'.PHP_EOL;
 echo '   $where=$val["where"];'.PHP_EOL;
 echo '   $Limit=$val["limit"];'.PHP_EOL;
 echo '} else {'.PHP_EOL;
 echo '   $tabel=$_POST["tabel"];'.PHP_EOL;
 echo '   $where=$_POST["where"];'.PHP_EOL;
 echo '   $Limit=$_POST["limit"];'.PHP_EOL;
 echo '}'.PHP_EOL;
