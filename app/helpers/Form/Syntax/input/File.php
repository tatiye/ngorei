...
<div class="<?=$row['colom_group'];?>">
  <div class="card-body pd-t-15 pb-10px mb-10px"style="border: 1px solid #c0ccda;">
        <div class="media">
          ...
          <div class="avatar">
            <img id="imagePreview"src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Google_Drive_icon_%282020%29.svg/2295px-Google_Drive_icon_%282020%29.svg.png" class="rounded-circle" alt="">
          </div>
          ...
          var fileType = file.type;
              ...
              if(!allowedTypes.includes(fileType)){
                ...
                `;
                 ...
                 $("#imagePreview").attr("src", 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Google_Drive_icon_%282020%29.svg/2295px-Google_Drive_icon_%282020%29.svg.png');
                 $("#buttonPreview").hide();
              } else {
                    var mytype=fileType.split('/');
                       if (mytype[1]=='vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
                           ...
                           var myIcon='https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Google_Drive_icon_%282020%29.svg/2295px-Google_Drive_icon_%282020%29.svg.png';
                       }
