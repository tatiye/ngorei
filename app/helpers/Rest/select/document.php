...
if (!file_exists(tatiye::dir()."/public/drive/".tatiye::dt("Y").'/'.tatiye::dt("M").'/'.$id)) {
  @mkdir(tatiye::dir()."/public/drive/".tatiye::dt("Y"), 0755);
  @mkdir(tatiye::dir()."/public/drive/".tatiye::dt("Y").'/'.tatiye::dt("M"), 0755);
  mkdir(tatiye::dir()."/public/drive/".tatiye::dt("Y").'/'.tatiye::dt("M").'/'.$id, 0755);
}
