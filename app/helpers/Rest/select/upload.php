...
if ($tabel=='appuserprofil') {
     require_once APPROOT.'/helpers/Rest/userid/upload.php';
 } else {
...
if (!file_exists(tatiye::dir()."/public/images/".tatiye::dt("Y").'/'.tatiye::dt("M").'/'.$id)) {
  ...
  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y"), 0755);
  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y").'/'.tatiye::dt("M"), 0755);
  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y").'/'.tatiye::dt("M").'/'.$id, 0755);
}
