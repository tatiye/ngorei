...
(function(){
    ...
    CommandLine = function(container){
        ...
        this.setUsername(Cookies.get("pic")+"@tatiyeNet");
    ...
    CommandLine.prototype.addCommand1 = function(command, callback, description){
        if(typeof description === 'undefined'){
            description = '';
        }
        this.commands.push({
    ...
    CommandLine.prototype.sText = function(message){
        this.output(message);
        // Utils.addClass(this.commandRow.commandRow,'sendText');
    };
    /**
