@import url('https://fonts.googleapis.com/css2?family=Fredoka:wght@300&family=Montserrat+Alternates:wght@300&family=Montserrat:wght@200&family=Source+Code+Pro:wght@300&display=swap');
/** {
...
.mac-window1.minimize:hover {
    top: 120%;
    -webkit-transition: all .5s;
    transition: all .5s
}

.mac-window1.maximize {
    height: 100%;
    max-height: 100%;
    width: 100%;
    max-width: 100%;
...
.mac-window1 .title-bar .buttons .close,
.mac-window1 .title-bar .buttons .maximize,
.mac-window1 .title-bar .buttons .minimize {
    float: left;
    height: 10px;
    width: 10px;
    border-radius: 50%;
...
.mac-window1 .title-bar .buttons .close:before,
.mac-window1 .title-bar .buttons .maximize:before,
.mac-window1 .title-bar .buttons .minimize:before {
    content: "";
    position: absolute;
    height: 1px;
    width: 8px;
...
.mac-window1 .title-bar .buttons .close:after,
.mac-window1 .title-bar .buttons .maximize:after,
.mac-window1 .title-bar .buttons .minimize:after {
    content: "";
    position: absolute;
    height: 1px;
    width: 8px;
...
.mac-window1 .title-bar .buttons:hover .close:after,
.mac-window1 .title-bar .buttons:hover .close:before,
.mac-window1 .title-bar .buttons:hover .maximize:after,
.mac-window1 .title-bar .buttons:hover .maximize:before,
.mac-window1 .title-bar .buttons:hover .minimize:after,
.mac-window1 .title-bar .buttons:hover .minimize:before {
    opacity: 1
}

.mac-window1 .title-bar .title {
    height: 100%;
    text-align: center;
    margin-right: 60px;
    font-family: Helvetica Neue, helvetica, arial, sans-serif;
