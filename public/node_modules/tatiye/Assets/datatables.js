...
export function setDatatables(row) {
    // console.log(setSplit(1,'/'))
                         ...
                         var setdropdown=`
                           ...
                           <div style="padding-right:230px;border-color: rgb(131 146 165 / 0%);box-shadow: 0 0 8px 2px rgb(28 39 60 / 0%);"class="dropdown-menu">
                            <div style="margin-top:-30px;"" class="menu">
                                       ...
                                       <ul class="menu-list">
                                            <li class="menu-item">
                                                <span class="menu-button">
                                                    <i class="feat feat-archive feat-scale-18"></i> <span class="bold pl-10px text-capitalize"> ${setSplit(1,'/')}</span>
                                                </span>
                                            </li>
                                       </ul>
                                    ...
                                    <ul class="menu-list">
                                        <li class="menu-item">
                                             <a onclick="useClickTabels(['archive','${rowData[Target]}','${row.db.fromAction.storage[4]}']);"href="javascript:void(0);" class="menu-button">
