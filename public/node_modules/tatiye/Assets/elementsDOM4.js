...
let count = 0;
export function elementsDOM4(item,dspage='1',dskeywords='') { 
   
        var router=rtsDOM('mainrouter')
        var getkeywords=dskeywords;
        ...
        let db=useHandel({
          ...
          var keyname=item.tabel;
          var elementcontent =item.primarykey;
          var setID=elementcontent; 
          $(elementcontent).hide(); 
          var useElement =item.elements; 

            $("#"+item.tabel+"_page").html(db.page);
            $("#"+item.tabel+"_limit").html(db.limit);
            $("#"+item.tabel+"_peging").html(db.total_peging);
            $("#"+item.tabel+"_data").html(db.total_data);
