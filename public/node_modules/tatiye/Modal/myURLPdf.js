...
export function myURLPdf(resheader,title,width,route,inikey,filename) { 
           ...
           <div class="
                ...
                <h5 id="headerTitelx"  class="mg-b-0">${title}</h5>
                  ...
                  <a onclick="minimize('${resheader}','${title}');" class="link-03 ml-10px mr-5px"href="javascript:void(0);">
                   ...
                   <a onclick="minimizeLage('${resheader}','${width}');"  class="link-03 ml-10px mr-5px"href="javascript:void(0);">
            ...
            <div id="body${resheader}"class="setModal-body">
              <div id="setScrol"style="max-height:500px;">
                    <div class="row row-xs" id="bodyFrom${resheader}">
                      <iframe width="100%" height="1300px" src="${filename}"></iframe>
                    </div>
               </div>
            </div>
          </div>
