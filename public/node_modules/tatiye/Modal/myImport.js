...
export function myImport(resheader,title,width,route,inikey,page=1) { 
                       ...
                       <div class="col-md-12" style="padding-right:2.4px;">
                           <div class="setModal-footer">
                             <button id="myclose${resheader}" type="button" class="btn btn-xs btn-white mr-10px">Batalkan</button>
                              <button id="sendEntriFile${resheader}"class="btn btn-xs btn-primary bold" type="submit">Import File </button>
