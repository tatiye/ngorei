...
export function setElementFirebase(read,property,key='') {
  //   console.log(property)
// console.log(read)
   const app = new components();
   count++;
          var useToken=useTabelToken(read['token']);
         ...
         if (property[1]=='add') {
              ...
              var rowsetIData =useHandelIDTabelFire(setPackageTabel+','+property[1]);
              var expoModelTitel='';    
         }
   ...
   if (property[0]=='from') {
        ...
        // console.log(rowfile.tableHead)
        // console.log(setPackage)
        // console.log(setPackageTabel)
         setModal({
           'titel':expoModelTitel,
           'width':'600px',
           'key'  :property[1],
